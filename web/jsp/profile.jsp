        ...
        <div id="main-wrapper">
            <div class="container">
                ...
                <div class="col-xs-10 col-sm-3 text-center">
                    <img src="http://api.randomuser.me/portraits/women/11.jpg" alt="profile picture" class="center-block img-circle img-responsive">
                </div>
                <form class="form-horizontal" id="form-profile" method="post" action="#">
                        <fieldset> 
                            <legend>Name: </legend> 
                            <!-- Text input-->
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="email" name="email" value="${user.email}" type="text" placeholder="Email address" class="form-control input-md" required="">
                        ...
                        <fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select id="Country" value="${user.country}"  name="Country" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button id="Edit" name="Edit" class="btn btn-primary" type="submit">Edit</button>
                                </div>
                            </div>
